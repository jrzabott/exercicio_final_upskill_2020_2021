...
public class GrausProficienciaService {
    ...
    /**
     *
     * @param codCT código da competência técnica da qual se pretende o registo
     * de graus de proficiência
     * @return o registo de graus de proficiência de uma competência técnica
     * identifica pelo código de competência técnica
     */
    public static RegistoGrausProficienciaDTO getGrausProficiencia(String codCT) {
        ...
        List<GrauProficiencia> grausProficiencia = competenciaTecnica.getGrausProficiencia();
    ...
    /**
     *
     * @param codCT código da competência técnica da qual que pretende obter um
     * grau de proficiência identificada pelo seu valor
     * @param valor valor do grau de proficiência que se pretende
     * @return um grau de proficiência identificado pelo seu valor e que
     * pertende a uma competência técnica identificada pelo código de
     * competência técnica
     */
    ...
    /**
     *
     * @param codCT código de competência técnica da qual se pretende adicionar
     * um grau de proficiência
     * @param grauProficienciaDTO grau de proficiência que se pretende adicionar
     * à competência técnica identificada pelo código de competência técnica
     */
    ...
    /**
     *
     * @param codCT código da competência técnica à qual pertende atualizar o
     * grau de proficiência identificado pelo seu valor
     * @param valor do valor do grau de proficiência que se pretende atualizar
     * @param grauProficienciaDTO grau de proficiência a ser atualizado
     * identificado pelo seu valor de grau de proficiência e que corresponde a
     * uma competência técnica identificada pelo seu código de competência
     * técnica
     */
    ...
    /**
     *
     * @param codCT código da competência técnica da qual se pretende remover um
     * grau de proficiência identificado pelo seu valor
     * @param valor valor do grau de proficiência que se pretende remover
     * pertencente à competência técnica identificada pelo código de competência
     * técnica
     */
