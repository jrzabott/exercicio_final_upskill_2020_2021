...
import t4j.app.controller.UIOrganizacaoController;
import t4j.app.dto.ColaboradorDTO;
import t4j.app.dto.EnderecoPostalDTO;
import t4j.app.dto.OrganizacaoDTO;

@Controller
public class CreateOrganizacao implements Initializable {
    ...
    @Autowired
    private UIOrganizacaoController uiroc;
...
//        });
    ...
    private void btnPopAction(ActionEvent event) {
        ...
        txtFieldEndCodigoPostalOrganizacao.setText(geraString(charsNum, 4) + "-"
                + geraString(charsNum, 3));
        ...
        txtFieldEmailOrganizacao.setText(String.format("%s@%s.com", companyName,
                companyName));
        ...
        txtFieldEmailGestor.setText(String.format("%s@%s.com", nameManager,
                companyName));
    }
    ...
    private void btnRegistarOrg(ActionEvent event) {
        try {
            ...
            epdto.setCodPostal(this.txtFieldEndCodigoPostalOrganizacao.getText()
                    .trim());
            epdto.setLocalidade(this.txtFieldEndLocalidadeOrganizacao.getText()
                    .trim());
            ...
            gestordto.setGestor("1");
            gestordto.setNifOrganizacao(this.txtFieldNifOrganizacao.getText().trim());
            ...
            // Organização//// ////////////////////////////////////
            odto.setNomeOrganizacao(this.txtFieldNomeOrganizacao.getText()
                    .trim());
            odto.setNifOrganizacao(this.txtFieldNifOrganizacao.getText().trim());
            odto.setEmailOrganizacao(this.txtFieldEmailOrganizacao.getText()
                    .trim());
            odto.setTelefoneOrganizacao(this.txtFieldTelefoneOrganizacao
                    .getText().trim());
            odto.setWebsiteOrganizacao(this.txtFieldWebsiteOrganizacao.getText()
                    .trim());
...
// Daniel Junior - 20210217 19:31 - Não existe mais este método estático
//            boolean registada = UIOrganizacaoController.registarOrganizacao(odto);
            boolean registada = uiroc.registarOrganizacao(odto);
//        
//
//        // Endereço Postal ////////////////////////////////////
...
//        boolean registada = UIOrganizacaoController.registarOrganizacao(odto);
    ...
    void associarParentUI(MainSceneController mainSceneController) {
        ...
        this.uIApplicationController = mainSceneController.getAppController();
    }
}
/*
Ny8-DPsTxm8rO5jwj1
