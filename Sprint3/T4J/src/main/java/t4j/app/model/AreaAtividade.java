...
public class AreaAtividade implements Serializable {
    ...
    /**
     *
     * @param descricaoBreve especifica uma nova descrição breve da área de
     * atividade
     */
    ...
    /**
     *
     * @param descricaoDetalhada especifica uma nova descrição detalhada da área
     * de atividade
     */
    ...
    /**
     *
     * @return retorna uma String com a descrição da área de atividade (código,
