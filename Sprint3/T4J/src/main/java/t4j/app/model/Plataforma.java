...
public class Plataforma implements Serializable {
    ...
    /**
     * Variável de instância - registo de anúncios
     */
    private RegistoAnuncios registoAnuncios;
    
    /**
     * Variável de instância - registo de tipos de regimento
     */
    private RegistoTiposRegimento registoTiposRegimento;
...
//    private Connection connection;
    ...
    private Plataforma(String designacao) {
        ...
        this.registoAnuncios = new RegistoAnuncios();
        this.registoTiposRegimento = new RegistoTiposRegimento();
//        this.connection = ConnectionFactory.getConnectionFactory().getConnection().getConnection();
    ...
    /**
     * 
     * @return registo de tipos de regimento
     */
