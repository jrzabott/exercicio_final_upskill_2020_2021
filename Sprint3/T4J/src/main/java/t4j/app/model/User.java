...
public class User implements Serializable {
    ...
    /**
     *
     * @param roles especifica um novo contentor do tipo ArrayList que guarda
     * todas as instâncias do tipo EnumRoles
     */
     ...
     *
     * @param roles1
     * @return cria uma ArrayList do tipo EnumRoles a partir de uma string que
     * entra por parâmetro
     */
