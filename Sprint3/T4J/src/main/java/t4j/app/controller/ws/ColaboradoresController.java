...
public class ColaboradoresController {
    ...
    /**
     *
     * @param nifOrganizacaoString NIF da organização da qual se pretende os
     * seus colaboradores
     * @return o registo de colaboradores de uma determinada organização
     * identificada pelo seu NIF
     */
     ...
     * @param nifOrganizacaoString NIF da organização da qual se pretende os
     * seus colaboradores
     * @return a lista de colaboradores de uma determinada organização
     * identificada pelo seu NIF
     */
