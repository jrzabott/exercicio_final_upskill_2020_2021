...
//            TarefasService.addTarefa(tarefaDTO);
    ...
    /**
     *
     * @param referencia referência da tarefa a ser atualizada no registo de
     * tarefas
     * @param tarefaDTO tarefa que vai ser atualizada
     * @return atualizada uma determinada tarefa no registo de tarefas
     * identifica pela sua referência de tarefa
     */
    @RequestMapping(value = "/tarefas/{referencia}",
    ...
    /**
     *
     * @param referencia referência da tarefa que se pretende remover do registo
     * de tarefas
     * @return remove uam determinada tarefa do registo de tarefas identifica
     * pela sua referência de tarefa
     */
    @RequestMapping(value = "/tarefas/{referencia}",
