...
public class OrganizacoesController {
     ...
     */
    @GetMapping(value = "/organizacoes", produces
            = MediaType.APPLICATION_XML_VALUE)
    public ResponseEntity<Object> getRegistoOrganizacoes() {
        try {
            RegistoOrganizacoesDTO ro = OrganizacoesService
    ...
    public RegistoOrganizacoesDTO getRegistoOrganizacoesUI() {
        RegistoOrganizacoesDTO result = OrganizacoesService
                .getRegistoOrganizacoes();
        return result;
    }
     ...
     */
    @PostMapping(value = "/organizacoes", consumes
    ...
    public ResponseEntity<Object> addOrganizacao(
            @RequestBody OrganizacaoDTO odto) {
        try {
//            OrganizacoesService.addOrganizacao(odto);
            this.os.addOrganizacao(odto);
