...
public class CompetenciasTecnicasController {
    ...
    public ResponseEntity<Object> getCompetenciasTecnicas() {
        try {
            RegistoCompetenciasTecnicasDTO registoCompetenciaTecnicaDTO = null;
//            registoCompetenciaTecnicaDTO
//                    = CompetenciasTecnicasService.getRegistoCompetenciasTecnicas();
     ...
     * @return uma comptência técnica identificada pelo seu código de
     * competência técnica
     */
    ...
    /**
     *
     * @param competenciaTecnicaDTO competência técnica a ser adicionada ao
     * registo de competências técnicas
     * @return adiciona uma nova competência técnica ao registo de competências
     * técnicas
     */
    @RequestMapping(value = "/competenciastecnicas",
...
//            CompetenciasTecnicasService.addCompetenciaTecnica(competenciaTecnicaDTO);
     ...
     * @param competenciaTecnicaDTO competência técnica a ser atualizada no
     * registo de competências técnicas
     * @return atualiza uma competência técnica identificada pelo seu código de
     * competência técnica
     */
    @RequestMapping(value = "/competenciastecnicas/{codigo}",
     ...
     * @return remove uma competência técnica identificada pelo seu código de
     * competência técnica
     */
    @RequestMapping(value = "/competenciastecnicas/{codigo}",
