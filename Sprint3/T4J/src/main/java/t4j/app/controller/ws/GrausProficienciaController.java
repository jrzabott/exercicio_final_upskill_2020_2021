...
public class GrausProficienciaController {
    ...
    /**
     *
     * @param codCT código de competência técnica da qual se pretende a lista de
     * graus de proficiência
     * @return o registo de graus de proficiência de uam determinada competência
     * técnica identificada pelo seu código de competência técnica
     */
    ...
    /**
     *
     * @param codigo código de competência técnica da qual se pretende a lista
     * de graus de proficiência
     * @param valor o valor do grau de proficiência que se pretende
     * @return o grau de proficiência de um determinado valor pertence a uma
     * determinada competência técnica identifica pelo seu código de competência
     * técnica
     */
    ...
    /**
     *
     * @param codigo código de competência técnica à qual se pretende adicionar
     * um novo grau de proficiência
     * @param grauProficienciaDTO grau de proficiência que se pretende adicionar
     * à competência técnica identifica pelo seu código de competência técnica
     * @return adicionada um grau de proficiência a uma determinada competência
     * técnica identifica pelo seu código de competência técnica
     */
    @RequestMapping(value = "/competenciastecnicas/{codigo}/grausproficiencia",
    ...
    /**
     *
     * @param codigo código de competência técnica à qual se pretende atulizar o
     * grau de proficiência
     * @param valor valor do grau de proficiência a ser atualizado
     * @param grauProficienciaDTO grau de proficiência a ser atualizado no
     * registo de gaus de proficiência
     * @return atualiza um grau de proficiência de uma determinada competência
     * técnica identifica pelo seu código de competência técnica
     */
    @RequestMapping(value = "/competenciastecnicas/{codigo}/grausproficiencia/{valor}",
    ...
    /**
     *
     * @param codigo código de competência técnica da qual se prentende remover
     * um grau de proficiência
     * @param valor valor do grau de proficiência que se pretende remover
     * @return remove um grau de proficiência identificada pelo seu valor
     * correspondente a uam competência técnica identifica pelo código de
     * competência técnica
     */
    @RequestMapping(value = "/competenciastecnicas/{codigo}/grausproficiencia/{valor}",
