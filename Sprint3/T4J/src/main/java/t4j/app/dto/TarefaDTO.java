...
@JsonPropertyOrder({"referencia", "designacao", "descricaoInformal", "descricaoTecnica", "duracaoEstimada", "custoEstimado", "categoria", "colaborador"})
...
public class TarefaDTO {
    ...
    public String toString() {
        ...
        sb.append("\nemailColaborador: ").append(emailColaborador);
        sb.append("\nnifOrganizacao: ").append(nifOrganizacao);
        sb.append("\n\n");
        return sb.toString();
    }
