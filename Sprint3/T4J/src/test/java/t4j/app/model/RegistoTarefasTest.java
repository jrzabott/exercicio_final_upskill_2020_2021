...
public class RegistoTarefasTest {
    ...
    public RegistoTarefasTest() {
        ...
        col = new Colaborador();
        tarefa = new Tarefa("UPskill", "Designação", "Descrição Informal", "Descrição Técnica", "760", "5000", cat, "teste@teste.pt", "987654321");
        tarefa2 = new Tarefa("UPskill2", "Designação", "Descrição Informal", "Descrição Técnica", "760", "5000", cat, "teste@teste.pt", "987654321");
        tarefa3 = new Tarefa("UPskill", "Designação", "Descrição Informal", "Descrição Técnica", "760", "5000", cat, "teste@teste.pt", "987654321");
