...
//        System.out.println("setValor Non-Digit");
        ...
        Throwable exception2 = assertThrows(ElementoInvalidoException.class, () -> {
            grauT.setValorGrauProficiencia(valor2);
        });
...
//        System.out.println("setValor Vazio");
        ...
        Throwable exception3 = assertThrows(ElementoInvalidoException.class, () -> {
            grauT.setValorGrauProficiencia(valor3);
        });
...
//        System.out.println("setValor maxLength");
        ...
        Throwable exception4 = assertThrows(ElementoInvalidoException.class, () -> {
            grauT.setValorGrauProficiencia(valor4);
        });
...
//        System.out.println("setDesignacao maxLength");
        ...
        Throwable exception3 = assertThrows(ElementoInvalidoException.class, () -> {
            grauT.setDesignacaoGrauProficiencia(designacao3);
        });
