...
public class RegistarOrganizacaoController implements Initializable {
    ...
    private void btnRegistarOrg(ActionEvent event) {
        try {
            ...
            // Endereço Postal ////////////////////////////////////
            epdto.setMorada(this.txtFieldEndMoradaOrganizacao.getText());
            ...
            // Gestor /////////////////////////////////////////////
            gestordto.setNome(this.txtFieldNomeGestor.getText());
            gestordto.setFuncao(this.txtFieldFuncaoGestor.getText());
            gestordto.setTelefone(this.txtFieldTelefoneGestor.getText());
            gestordto.setEmail(this.txtFieldEmailGestor.getText());
            ...
            odto.setNifOrganizacao(this.txtFieldNifOrganizacao.getText());
            odto.setEmailOrganizacao(this.txtFieldEmailOrganizacao.getText());
            odto.setTelefoneOrganizacao(this.txtFieldTelefoneOrganizacao.getText());
