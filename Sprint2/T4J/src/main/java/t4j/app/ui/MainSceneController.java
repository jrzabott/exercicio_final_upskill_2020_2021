...
public class MainSceneController implements Initializable {
    ...
    private void menuItemSairAction(ActionEvent event) {
        ...
        myWindow.fireEvent(new WindowEvent(myWindow, WindowEvent.WINDOW_CLOSE_REQUEST));
    }

    @FXML
    private void menuItemSobre(ActionEvent event) {
        AlertaUI.criarAlerta(Alert.AlertType.INFORMATION, TITULO_APLICACAO, "Acerca.", "@Copyright\nSprint 2 - Grupo 3\nBruno Barbosa, Daniel Junior, Fernando Crista, Jorge Pires\nUPskill 2020/2021").show();
    }
    ...
    private void loadGUI(EnumFXMLs efxml) {
        try {
            ...
            AlertaUI.criarAlerta(Alert.AlertType.ERROR, TITULO_APLICACAO, "Erro.", ex.getMessage() + "\n" + Arrays.toString(ex.getStackTrace())).show();
        }
        stage.show();
    }
