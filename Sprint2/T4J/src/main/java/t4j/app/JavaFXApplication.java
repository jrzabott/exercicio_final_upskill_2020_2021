...
public class JavaFXApplication extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        this.stage.setTitle(TITULO_APLICACAO);
        this.stage.setScene(scene);

        this.stage.sizeToScene();
        this.stage.setResizable(false);
        this.stage.setOnCloseRequest((WindowEvent event) -> {
            Alert alerta = AlertaUI.criarAlerta(Alert.AlertType.CONFIRMATION, TITULO_APLICACAO, "Confirmação da ação.", "Deseja mesmo encerrar a aplicação?");
