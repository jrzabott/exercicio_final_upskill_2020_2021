...
public class CategoriaTarefasService {
    ...
    public Long addCategoriaTarefa(CategoriaTarefaDTO ctdto) {
        ...
        //////////////////////////////////////////////////
        CategoriaTarefa categoriaTarefa = categoriaTarefaDTO2CategoriaTarefa(ctdto);
        try {
            ...
            for (CaraterCompetenciaTecnicaDTO cctdto : ctdto.getCaraterCompetenciaTecnica()) {
                ...
                gp = grauDTO2Grau(cctdto.getGrauProficiencia());
                ...
                ct = competenciaTecnicaDTO2CompetenciaTecnica(cctdto.getCompetenciaTecnica());
            ...
            categoriaTarefa.setAreaAtividade(areaAtividadeDTO2AreaAtividade(ctdto.getAreaAtividade()));
    ...
    public RegistoCategoriasDTO getRegistoCategorias() {
        ...
        for (CategoriaTarefa categoriaTarefa : list) {
            CategoriaTarefaDTO ctdto = categoriaTarefa2CategoriaTarefaDTO(categoriaTarefa);
            if (ctdto != null) {
                listDTO.add(ctdto);
            }
        }
