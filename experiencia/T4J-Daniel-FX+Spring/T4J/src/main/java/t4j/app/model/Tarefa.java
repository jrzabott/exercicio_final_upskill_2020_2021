...
//    @JoinColumn(referencedColumnName = "nif", foreignKey = @ForeignKey(name = "FK_TAREFA_ORGANIZACAO"), name ="nif_organizacao")
     ...
     */
    public Tarefa(String referencia, String designacao, String descricaoInformal, String descricaoTecnica, String duracaoEstimada, Double custoEstimado, CategoriaTarefa categoria, String emailColaborador, String nifOrganizacao) {
     ...
     * @param categoria categoria em qual a tarefa se enquadra
     */
    public Tarefa(String referencia, String designacao, String descricaoInformal, String descricaoTecnica, String duracaoEstimada, Double custoEstimado, CategoriaTarefa categoria) {
        setReferencia(referencia);
        setDesignacao(designacao);
        setDescricaoInformal(descricaoInformal);
        setDescricaoTecnica(descricaoTecnica);
    ...
    public Tarefa(Tarefa outraTarefa) {
        ...
        this.custoEstimado = outraTarefa.custoEstimado;
        this.categoria = new CategoriaTarefa(outraTarefa.categoria);
        this.emailColaborador = outraTarefa.emailColaborador;
        this.nifOrganizacao = outraTarefa.nifOrganizacao;
    }
    ...
    public void setCustoEstimado(Double custoEstimado) throws ElementoInvalidoException {
            this.custoEstimado = custoEstimado;
    ...
    /**
     *
     * @param nifOrganizacao especifica um novo nif da organização à qual pertence o colaborador
    ...
    /**
     *
     * @return retorna uma String com a descrição da tarefa (referência, designação, descrição
     * informal, descrição técnica, duração estimada, custo estimado, categoria, colaborador, email
     * do colaborador, nif da organização)
     */
    @Override
    ...
    public int hashCode() {
        int hash = 5;
        hash = 37 * hash + Objects.hashCode(this.referencia);
        hash = 37 * hash + Objects.hashCode(this.designacao);
        hash = 37 * hash + Objects.hashCode(this.descricaoInformal);
        hash = 37 * hash + Objects.hashCode(this.descricaoTecnica);
        hash = 37 * hash + Objects.hashCode(this.duracaoEstimada);
        hash = 37 * hash + Objects.hashCode(this.custoEstimado);
        hash = 37 * hash + Objects.hashCode(this.categoria);
        hash = 37 * hash + Objects.hashCode(this.colaborador);
        hash = 37 * hash + Objects.hashCode(this.emailColaborador);
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.descricaoInformal, other.descricaoInformal)) {
            return false;
        }
        if (!Objects.equals(this.descricaoTecnica, other.descricaoTecnica)) {
            return false;
        }
        if (!Objects.equals(this.duracaoEstimada, other.duracaoEstimada)) {
            return false;
        }
        if (!Objects.equals(this.custoEstimado, other.custoEstimado)) {
            return false;
        }
        if (!Objects.equals(this.emailColaborador, other.emailColaborador)) {
            return false;
        }
