...
public class RegistoAreasAtividade implements Serializable {
     ...
     *
     * @param areasAtividade contentor do tipo ArrayList que guarda todas as
     * instâncias do tipo área de atividade
     */
     ...
     *
     * @param outroRegistoAreasAtividade instância do tipo lista de áreas de
     * atividade a ser copiada
     */
     ...
     * @return a área de atividade ao qual pertence o código de área de
     * atividade introduzido por parâmetro
     */
    ...
    /**
     *
     * @param areaAtividade instância do tipo área de atividade a ser adicionada
     * ao contentor areasAtividade
     * @return
     */
     ...
     *
     * @param codigoAreaAtividade código de área de atividade
     * @param aa instância do tipo área de atividade a ser atualizada no
     * contentor areasAtividade
     * @throws ElementoNaoExistenteException
     */
    ...
    public int hashCode() {
        int hash = 7;
        hash = 79 * hash + Objects.hashCode(this.areasAtividade);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final RegistoAreasAtividade other = (RegistoAreasAtividade) obj;
        if (!Objects.equals(this.areasAtividade, other.areasAtividade)) {
            return false;
        }
        return true;
    }
     ...
     * @return retorna a instância do tipo área de atividade para adição ao
