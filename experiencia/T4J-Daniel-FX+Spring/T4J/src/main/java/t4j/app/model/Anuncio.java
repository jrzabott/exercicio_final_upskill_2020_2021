...
public class Anuncio implements Serializable {
    ...
    /**
     * Variável de instância - referência do anúncio (será igual à referência da tarefa à qual se
     * refere o anúncio)
     */
    @Id
     ...
     */
    public Anuncio(String referencia, LocalDate dataInicioPublicitacao, LocalDate dataFimPublicitacao,
     ...
     */
    public void setDataInicioPublicitacao(LocalDate dataInicioPublicitacao) {
        this.dataInicioPublicitacao = dataInicioPublicitacao;
    }
     ...
     * @throws NullPointerException
     */
    public void setDataFimPublicitacao(LocalDate dataFimPublicitacao) {
        this.dataFimPublicitacao = dataFimPublicitacao;
    }
     ...
     * @throws NullPointerException
     */
    public void setDataInicioCandidatura(LocalDate dataInicioCandidatura) {
        this.dataInicioCandidatura = dataInicioCandidatura;
    }
     ...
     * @throws NullPointerException
     */
    public void setDataInicioSeriacao(LocalDate dataInicioSeriacao) {
        this.dataInicioSeriacao = dataInicioSeriacao;
    }
     ...
     * @throws NullPointerException
     */
    public void setDataFimSeriacao(LocalDate dataFimSeriacao) {
        this.dataFimSeriacao = dataFimSeriacao;
    }
    ...
    /**
     *
     * @return retorna uma String com a descrição do anúncio(referência, data de registo do anúncio,
     * data de início de publicitação, data de fim de publicitação, da de início de candidatura,
     * data de fim de candidatura, da de início de seriação, data de fim de seriação, id do tipo de
     * regimento)
     */
    @Override
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + Objects.hashCode(this.dataRegistoAnuncio);
        hash = 97 * hash + Objects.hashCode(this.dataInicioPublicitacao);
        hash = 97 * hash + Objects.hashCode(this.dataFimPublicitacao);
        hash = 97 * hash + Objects.hashCode(this.dataInicioCandidatura);
        hash = 97 * hash + Objects.hashCode(this.dataFimCandidatura);
        hash = 97 * hash + Objects.hashCode(this.dataInicioSeriacao);
        hash = 97 * hash + Objects.hashCode(this.dataFimSeriacao);
        hash = 97 * hash + Objects.hashCode(this.idTipoRegimento);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.dataRegistoAnuncio, other.dataRegistoAnuncio)) {
            return false;
        }
        if (!Objects.equals(this.dataInicioPublicitacao, other.dataInicioPublicitacao)) {
            return false;
        }
        if (!Objects.equals(this.dataFimPublicitacao, other.dataFimPublicitacao)) {
            return false;
        }
        if (!Objects.equals(this.dataInicioCandidatura, other.dataInicioCandidatura)) {
            return false;
        }
        if (!Objects.equals(this.dataFimCandidatura, other.dataFimCandidatura)) {
            return false;
        }
        if (!Objects.equals(this.dataInicioSeriacao, other.dataInicioSeriacao)) {
            return false;
        }
        if (!Objects.equals(this.dataFimSeriacao, other.dataFimSeriacao)) {
            return false;
        }
        if (!Objects.equals(this.idTipoRegimento, other.idTipoRegimento)) {
            return false;
        }
        return true;
    }
