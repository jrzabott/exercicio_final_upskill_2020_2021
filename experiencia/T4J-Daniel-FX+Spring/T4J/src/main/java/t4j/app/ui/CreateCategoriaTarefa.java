        ...
        tbColGrau.setCellFactory(t -> {
            ComboBoxTableCell cbtc = new ComboBoxTableCell() {
                ...
                public void updateItem(Object item, boolean empty) {
                    ...
                    // Parte Grafica da ComboBox
                    if (item == null || empty
                            || ((GrauProficienciaDTO) item).getDesignacao() == null
                            || ((GrauProficienciaDTO) item).getDesignacao().isEmpty()) {
                        setGraphic(null);
                        setText("");
                    } else {
                        setText(((GrauProficienciaDTO) item).toString());
                    }
                }
            };
            return cbtc;
