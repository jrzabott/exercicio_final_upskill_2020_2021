...
public class User implements Serializable {
     ...
     * @return 
     */
    public ArrayList<EnumRoles> getRolenames() {
        return rolenames;
    }
     ...
     * @return 
     */
    public static char getROLES_DELIMITER() {
     ...
     * @param rolenames 
     */
    public void setRolenames(ArrayList<EnumRoles> rolenames) {
    ...
    public int hashCode() {
        ...
        hash = 89 * hash + Objects.hashCode(this.rolenames);
        return hash;
    }
