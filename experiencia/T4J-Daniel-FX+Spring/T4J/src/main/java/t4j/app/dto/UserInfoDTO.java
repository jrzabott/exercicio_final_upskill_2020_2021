...
public class UserInfoDTO {
    ...
    public String toString() {
        ...
        sb.append("UserInfoDTO{username=").append(username);
        sb.append(", password=").append(password);
        sb.append(", email=").append(email);
        sb.append(", logindate=").append(logindate);
        sb.append(", rolenames=").append(rolenames);
        sb.append(", app_context=").append(app_context);
        sb.append(", session=").append(session);
        sb.append(", lastHttpResponse=").append(lastHttpResponse);
        sb.append(", lastHttpResponseCode=").append(lastHttpResponseCode);
        sb.append(", organizacao=").append(organizacao);
